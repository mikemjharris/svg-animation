...
function init () {
  ...
  var pathsToAppend = ( '<path d="M0 0 Z" stroke="#808600" stroke-width="0" stroke-linecap="round" fill="#1EB287">' + createAnimate( letters ));
...
var pathToAppend = ( '<path d="M0 0 Z" stroke="#808600" stroke-width="0" stroke-linecap="round" fill="#1EB287">' + createAnimate( letters ));
$('#svgcontainer').append('<svg>' + pathToAppend+ '</svg>');
